        ...
        <BrowserRouter>
          <Routes>
            <Route>
              ...
              />
              <Route
                path="/updatePasswordCheck"
                element={
                  <UpdatePassword setUserAuthenticated={setUserAuthenticated} />
                }
              ></Route>
              <Route
                path="/updateUserPassword/:department/:id"
                element={
                  userAuthenticated ? (
          ...
          <div className="row">
            ...
            <div className="col-9">
                  ...
                  <Route
                    ...
                    element={
                      department == "hr-employee" ? (
                        <CreateCandidate
                          department={department}
                          trainingCompletionFeedback={"This is a test"}
                          bdRemarksFeedback={"This is another test"}
                        />
                      ) : (
                        <Homepage />
                      )
              ...
              ></Route> */}
                  ...
                  ></Route>
                  <Route
                    path=":department/viewEmployee/:id"
